...
def test_track():
    ...
    expected_attributes = {
        ...
        "audio_path": os.path.normpath(
            os.path.join(
                "tests/resources/mir_datasets/filosax/", "Participant 1/02/Sax.wav"
            )
        ),
        ...
        "musicXML_path": os.path.normpath(
            os.path.join(
                "tests/resources/mir_datasets/filosax/", "Participant 1/02/Sax.musicxml"
            )
        ),
        "pdf_path": os.path.normpath(
            os.path.join(
                "tests/resources/mir_datasets/filosax/", "Participant 1/02/Sax.pdf"
            )
        ),
    }
